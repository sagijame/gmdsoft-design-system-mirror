...
| `plugins/gmdsoft-design-system/` | 배포 플러그인 (skill 단일 출처) — `.claude-plugin/plugin.json` + `skills/gmdsoft-design-system/`(SKILL.md 라우터 + `components/*.md` 29종 + `DESIGN.md`·`COLOR_TOKENS.md`·`tokens.json`·`guidelines.md` + `preview*.html`) + `commands/`(슬래시 커맨드 3종) |
